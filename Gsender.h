...
class Gsender
{
    ...
    private:
        ...
        // GMAIL account creds must be converted to Base64. 
        // You can do that here --> https://www.base64encode.org/
        const char* EMAILBASE64_LOGIN = "YOUR_LOGIN_IN_BASE_64";
        const char* EMAILBASE64_PASSWORD = "YOUR_PASSWORD_IN_BASE_64";
  
        const char* FROM = "YOUR_GMAIL_ACCOUNT@gmail.com";
